...
> This page mirrors the project's `CONTRIBUTING.md` for browsability inside the documentation site.
...
Before you start, please read [`CODE_OF_CONDUCT.md`](https://github.com/pumacp/puma-community/blob/main/CODE_OF_CONDUCT.md).
By submitting a Pull Request you agree to the licensing terms in
[`LICENSE`](https://github.com/pumacp/puma-community/blob/main/LICENSE) and to the consent fields encoded in your submission
...
are governed by the [Contributor Covenant v2.1](https://github.com/pumacp/puma-community/blob/main/CODE_OF_CONDUCT.md).
