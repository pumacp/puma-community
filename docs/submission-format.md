...
- [Anonymity and Privacy](https://github.com/pumacp/puma-community/wiki/Anonymity-And-Privacy) — what is and isn't
  transmitted in the fields above, and how the PII scanner protects against
  accidental disclosures.
- [Validation Process](https://github.com/pumacp/puma-community/wiki/Validation-Process) — how the schema and integrity
